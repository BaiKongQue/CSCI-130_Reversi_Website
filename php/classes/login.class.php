...
// PRIVATE
	 ...
	 * @return boolean: wether the password was valid or not.
	 */
	private function pass_check(string $userPassword, string $dbPassword): boolean{
	 ...
	 * @return boolean: wether the user successfully logged in
	 */
	private function login(string $username, string $userPassword): boolean {
...
// PUBLIC
	 ...
	 * @return boolean: wether the user successfully login or not
	 */
	public function run_login(string $u, string $p): boolean {
	 ...
	 * @return boolean: wether the user is logged in or not
	 */
	public function login_check(): boolean {
